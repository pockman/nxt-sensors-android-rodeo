...
public class FileSystem {
   ...
   * Upload.
   *
   * @param localSource the local source
   * @return the byte
   */
   ...
   * @param destination Where the file will be saved. Can be directory or full path and filename.
   * @return Error code.
   */
   ...
   *
   * @param fileName the file name
   * @param destination Where the file will be saved. Can be directory or full path and filename. e.g.
